...
import { useGetDoctorProfileQuery, Availability } from "@/services/doctorApi";
...
const DoctorProfilePage = () => {
  const { data: doctor, isLoading, isError } = useGetDoctorProfileQuery();

  if (isLoading) return <p>Loading doctor details...</p>;
  if (isError || !doctor) return <p>Failed to load doctor details.</p>;
  return (
    <div className=" p-6 dark:bg-gray-900 rounded-xl shadow">
      <div className="p-6 space-y-8 border-2 rounded-lg">
        <div className="flex justify-between">
          ...
          {/* Available */}
          <Card className="w-[350px] h-[300px] dark:bg-gray-800 border-2 py-12">
            <CardHeader className="flex items-center space-x-4">
              <div>
                <CardTitle className="text-2xl font-black">
                  Availability
